...
class UsersApi(object):
    ...
    def get_user_device_types_with_http_info(self, user_id, **kwargs):
        ...
        if 'include_shared' in params:
            query_params['includeShared'] = 'true' if params['include_shared'] == True else 'false'
    ...
    def get_user_devices_with_http_info(self, user_id, **kwargs):
        ...
        if 'include_properties' in params:
            query_params['includeProperties'] = 'true' if params['include_properties'] == True else 'false'
    ...
    def get_user_rules_with_http_info(self, user_id, **kwargs):
        ...
        if 'exclude_disabled' in params:
            query_params['excludeDisabled'] = 'true' if params['exclude_disabled'] == True else 'false'
        if 'count' in params:
            query_params['count'] = params['count']
        if 'offset' in params:
            query_params['offset'] = params['offset']
