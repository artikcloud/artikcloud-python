...
class OutputRule(object):
    ...
    """
    def __init__(self, aid=None, created_on=None, description=None, enabled=None, error=None, id=None, index=None, invalidated_on=None, language_version=None, modified_on=None, name=None, rule=None, uid=None, warning=None, owner=None):
        """
    ...
    def owner(self):
        """
        Gets the owner of this OutputRule.

        :return: The owner of this OutputRule.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """
        Sets the owner of this OutputRule.

        :param owner: The owner of this OutputRule.
        :type: str
        """
